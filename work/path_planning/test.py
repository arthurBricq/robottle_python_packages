...
binary_dilated, binary = map_utils.filter_map(m)
N = 10
...
zones = map_utils.get_zones_from_previous(corners, zones)
targets = map_utils.get_targets_from_zones(np.array(zones))
random_area = map_utils.get_random_area(zones)
