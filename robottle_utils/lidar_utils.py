...
def check_obstacle_ahead(distances, angles, save_index = None, length_to_check = 250, half_robot_width = 180, threshold = 12):
    ...
    to_return = (np.count_nonzero(obstacles1) + np.count_nonzero(obstacles2)) >= threshold
